...
At the moment we draw these conclusions, Hotjar registers 293 total accesses, 85 for the desktop version and 208 for the mobile one. About 85% of users were interested in finding out what's below the initial presentation, and 37% managed to get to the bottom of the page. Because the subscribe form is the first to appear when the page opens, most clicks have been made inside it. Next, visitors were interested in the areas presented in the navigation bar, namely Download, Features and Contact. Enough were eager enough to press Start now for free! or on the representative icons of the operating systems on which the application will be launched, even if it was mentioned that the application is still in development. In the end, the fewest wanted to view our Facebook page, get our email address, or give us feedback. These things can only confirm that there is interest in this application.
