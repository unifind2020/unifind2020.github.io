...
We realized that users should be able to interact with the application before creating an account, so the registration section has become mandatory just to ask a question or add feedback.
